...
(async function main() {
  try {
    ...
    console.log(`Minting token ${NUM_TOKENS}`);
    await nftContract.methods.mintNFT(OWNER_ADDRESS, NUM_TOKENS, proof.proof.a, proof.proof.b, proof.proof.c , proof.inputs).send({ from: OWNER_ADDRESS, "gas": 5000000, "gasPrice": 100000000000 }, (error, result) => {
