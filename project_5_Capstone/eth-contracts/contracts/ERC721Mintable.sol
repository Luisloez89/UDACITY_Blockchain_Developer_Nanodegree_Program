...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Address already owns of this token");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((getOwner() == msg.sender) || isApprovedForAll(msg.sender, ownerOf(tokenId)), "Caller not authorised");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Invalid owner");
...
contract HouseListingToken is ERC721Metadata("House Listing Token", "HLT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
